              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                <form method="get" className="flex gap-2">
                  <input
                    ...
                    placeholder="검색..."
                    defaultValue={search}
                    className="px-4 py-2 border border-zinc-300 rounded-lg bg-white text-black"
                  />
                  <button
                    type="submit"
                  ...
                  {search ? (
                    <Link
                      href="/bff-demo"
                      className="px-4 py-2 border border-zinc-300 rounded-lg text-black hover:bg-zinc-50"
                    >
                      초기화
                    </Link>
                  ) : null}
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        >
                          ...
                          <span className="inline-block mt-1 px-2 py-1 text-xs bg-zinc-100 text-zinc-700 rounded">
                            {user.role}
                          </span>
                        </Link>
                        <DeleteUserForm
