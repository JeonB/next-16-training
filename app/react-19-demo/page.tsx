      ...
      <div className="mb-12">
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><code className="bg-white px-1 rounded">use</code> 훅 - Promise와 Context 처리</li>
            <li>ref를 일반 prop으로 전달 (forwardRef deprecated)</li>
            <li>Server Actions와 Form Actions</li>
            <li><code className="bg-white px-1 rounded">useOptimistic</code> 훅</li>
            <li><code className="bg-white px-1 rounded">useFormStatus</code> 및 <code className="bg-white px-1 rounded">useFormState</code> 훅</li>
          </ul>
        </div>
      </div>
      ...
      <div className="space-y-16">
        <section className="border-b pb-12">
          ...
          <p className="text-muted-foreground mb-6">
            React 19에서 도입된 <code className="bg-gray-100 px-1 rounded">use</code> 훅은
        ...
        <section className="border-b pb-12">
          ...
          <p className="text-muted-foreground mb-6">
            React 19부터 <code className="bg-gray-100 px-1 rounded">forwardRef</code>가
        ...
        <section className="border-b pb-12">
          ...
          <p className="text-muted-foreground mb-6">
            ...
            <code className="bg-gray-100 px-1 rounded">action</code> prop을 통해
        ...
        <section className="border-b pb-12">
          ...
          <p className="text-muted-foreground mb-6">
            <code className="bg-gray-100 px-1 rounded">useOptimistic</code>는
        ...
        <section className="pb-12">
          ...
          <p className="text-muted-foreground mb-6">
            <code className="bg-gray-100 px-1 rounded">useFormStatus</code>와
            <code className="bg-gray-100 px-1 rounded">useFormState</code>는
