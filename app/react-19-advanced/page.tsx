    ...
    <main className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      <div className="space-y-16">
        <section className="border-b pb-12">
          <h2 className="text-3xl font-bold mb-4">1. useTransition과 startTransition</h2>
          <p className="text-muted-foreground mb-6">
            비동기 상태 업데이트를 처리하고 UI의 반응성을 유지하는 방법을 학습합니다.
          </p>
          <TransitionDemo />
        </section>
        ...
        <section className="pb-12">
          <h2 className="text-3xl font-bold mb-4">3. Server & Client Components 통합</h2>
          <p className="text-muted-foreground mb-6">
            Next.js App Router에서 Server Components와 Client Components를 효과적으로 통합하는 패턴입니다.
          </p>
